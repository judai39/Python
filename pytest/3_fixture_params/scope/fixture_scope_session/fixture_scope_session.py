...
if __name__=="__main__":
    # 会话中的执行顺序由main调用顺序决定
    pytest.main(["-vs","pytest/3_fixture_params/scope/fixture_scope_session/fixture_scope_session_odds.py","pytest/3_fixture_params/scope/fixture_scope_session/fixture_scope_session.py"])